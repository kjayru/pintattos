...
<body>
    ...
    <div style="display: none">Explore Instagram online with the best experience, follow interesting people, post comment and share photo to Facebook, twitter and all other websites.</div>
...
<div class='splitter'></div><a href='/'  class='currentPage' ><img src='img/nav_home.png' alt='' /></a>

                <div class='splitter'></div><a href='javascript:void(0);' class='navButtonExplore'  ><img src='img/nav_globe.png' alt='' /></a>
...
<div class='splitter'></div><a href='/Account/LoginWithService?serviceType=instagram&redirectUrl=%2F'   ><img src='img/nav_user.png' alt='Sign in with Instagram' /><span>Sign in with Instagram</span></a>
...
<div class='splitter'></div><a href='https://pinsta.zendesk.com/hc' target='_blank'  ><img src='img/nav_help.png' alt='' /></a>            <div class='splitter'></div>
...
<!--- seccion centro-->                
    ...
    <ul class="dropdown-menu shareDropDown">
    ...
    <div class="loadingContentWrapper">
        ...
        <div class="loadingContent">
            ...
            <img src="/Content/MultiView/ajax-loader_2.gif" alt="loading" />

        </div>

    </div>

    <div class="modal hide" id="mediaDetail">

        <div class="modal-body">

            <div class="mediaDetailContainer"></div>
